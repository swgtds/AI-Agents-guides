...
- **Project README**: [README.md](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/README.md)
- **Primary Agent Config**: [src/mastra/index.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/index.ts)
- **Tool**: [src/mastra/tools/tournament-coordinator-tool.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/tools/tournament-coordinator-tool.ts)
- **Workflow**: [src/mastra/workflows/tournament-coordinator-workflow.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/workflows/tournament-coordinator-workflow.ts)
- **Sub-Agents**: [src/mastra/agents/](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/agents/)
- **Demo Express Server**: [server.js](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/server.js) (endpoints: `/tournament`, `/health`)
...
Key components:
- Main agent registry: [src/mastra/index.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/index.ts)
- Coordination tool: [src/mastra/tools/tournament-coordinator-tool.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/tools/tournament-coordinator-tool.tshttps://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/tools/tournament-coordinator-tool.ts)
- Workflow definition: [src/mastra/workflows/tournament-coordinator-workflow.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/workflows/tournament-coordinator-workflow.ts)
- Sub-agent logic (domain specialization): [src/mastra/agents/](https://github.com/swagata-cometchat/gaming-AI-Agent/tree/main/tournament-coordinator-agent/src/mastra/agents)
- Demo server (quick start without full Mastra routing): [server.js](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/server.js)
...
- Runtime & Config
  - [package.json](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/package.json), [tsconfig.json](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/tsconfig.json)
- Mastra Core
  - [src/mastra/index.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/index.ts) (agents + workflows + storage + logger)
  - [src/mastra/workflows/tournament-coordinator-workflow.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/workflows/tournament-coordinator-workflow.ts)
  - [src/mastra/tools/tournament-coordinator-tool.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/tools/tournament-coordinator-tool.ts)
- Agents (Specialists)
  - [tournament-coordinator-agent.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/agents/tournament-coordinator-agent.ts) (router logic class)
  - [tournament-setup-agent.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/agents/tournament-setup-agent.ts)
  - [match-scheduling-agent.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/agents/match-scheduling-agent.ts)
  - [player-management-agent.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/agents/player-management-agent.ts)
  - [live-tournament-agent.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/agents/live-tournament-agent.ts)
- Demo Server
  - [server.js](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/server.js) (Express: `/tournament`, `/health`)
...
Check [src/mastra/index.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/tournament-coordinator-agent/src/mastra/index.ts) for agent initialization (name, instructions, memory).
...
<Steps>
  ...
  Verify <code>curl http://localhost:4111/health</code> (Express) or list agents via Mastra base route.
  </Step>
...
```bash
# Tournament setup
curl -X POST http://localhost:4111/tournament \
