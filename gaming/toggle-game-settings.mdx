...
- Tools
  ...
  - [src/mastra/tools/index.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/toggle-game-settings/src/mastra/tools/index.ts)
- Mastra registry / startup
  - [src/mastra/index.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/toggle-game-settings/src/mastra/index.ts)
