...
- **Project README**: [./README.md](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/README.md)
- **Swagger UI (local)**: [http://localhost:4111/swagger-ui](http://localhost:4111/swagger-ui) (if dev server started with Mastra)
- **Knowledge directory**: [./knowledge/gaming/](https://github.com/swagata-cometchat/gaming-AI-Agent/tree/main/ingame-tutorials-and-faq/knowledge/gaming)
...
- Runtime & config
  - [package.json](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/package.json), [tsconfig.json](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/tsconfig.json), [README.md](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/README.md)
- Agent
  - [src/mastra/agents/gaming-tutorial-agent.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/src/mastra/agents/gaming-tutorial-agent.ts)
- Tools
  - [src/mastra/tools/game-guide-retriever.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/src/mastra/tools/game-guide-retriever.ts)
  - [src/mastra/tools/ingest-game-guides.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/src/mastra/tools/ingest-game-guides.ts)
  - [src/mastra/tools/index.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/src/mastra/tools/index.ts)
- Server
  - [src/mastra/index.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/src/mastra/index.ts)
  - [src/mastra/server/routes.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/src/mastra/server/routes.ts)
  - [src/mastra/server/routes/chat.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/src/mastra/server/routes/searchGuides.ts)
  - [src/mastra/server/routes/ingest.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/src/mastra/server/routes/ingest.ts)
  - [src/mastra/server/util/safeErrorMessage.ts](https://github.com/swagata-cometchat/gaming-AI-Agent/blob/main/ingame-tutorials-and-faq/src/mastra/server/util/safeErrorMessage.ts)
- Knowledge
  - [knowledge/gaming/*.md](https://github.com/swagata-cometchat/gaming-AI-Agent/tree/main/ingame-tutorials-and-faq/knowledge/gaming) 
...
<CardGroup>
  <Card title="Widget" icon="/docs/images/products/ai-agents.svg" description="Embed script for instant assistant" href="/widget/ai-agents" horizontal />
  <Card title="React UI Kit" icon="/docs/images/icons/react.svg" href="https://www.cometchat.com/docs/ui-kit/react/ai-assistant-chat" horizontal>Prebuilt chat components</Card>
</CardGroup>
