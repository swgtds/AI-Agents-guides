...
- **Project README**: [README.md](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/README.md)
- **Agent**: [src/mastra/agents/retail-faq-agent.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/agents/retail-faq-agent.ts)
- **Tools**: [src/mastra/tools/docs-retriever.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/tools/docs-retriever.ts), [src/mastra/tools/ingest-sources.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/tools/ingest-sources.ts)
- **Routes**: [src/mastra/server/routes/routes/searchDocs.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/server/routes/routes/searchDocs.ts), [src/mastra/server/routes/routes/ingest.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/server/routes/routes/ingest.ts)
- **Server Root**: [src/mastra/server/routes.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/server/routes.ts), [src/mastra/index.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/index.ts)
- **Environment Variables**: [.env.example](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/.env.example)
...
- Runtime & config
  - [package.json](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/package.json), [tsconfig.json](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/tsconfig.json), [.env.example](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/.env.example)
- Knowledge
  - [knowledge/retail/*.md](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/knowledge/retail)
- Mastra setup
  - [src/mastra/index.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/index.ts)
  - [src/mastra/server/routes.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/server/routes.ts)
  - [src/mastra/server/routes/routes/searchDocs.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/server/routes/searchDocs.ts)
  - [src/mastra/server/routes/routes/ingest.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/server/routes/routes/ingest.ts)
  - [src/mastra/server/util/safeErrorMessage.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/server/util/safeErrorMessage.ts)
- Agents & Tools
  - [src/mastra/agents/retail-faq-agent.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/agents/retail-faq-agent.ts)
  - [src/mastra/tools/docs-retriever.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/tools/docs-retriever.ts)
  - [src/mastra/tools/ingest-sources.ts](https://github.com/swagata-cometchat/ecommerce-AI-Agent/blob/main/retail-faq-knowledge-agent/src/mastra/tools/ingest-sources.ts)
