...
- README: `automate-account-statements/README.md`
- Agent: `src/mastra/agents/account-statements-agent.ts`
- Tools: `src/mastra/tools/` (get-account, generate-statement, get-statement-history)
- Mastra setup: `src/mastra/index.ts`
- Local endpoint (generate): `POST /api/agents/accountStatementsAgent/generate`
