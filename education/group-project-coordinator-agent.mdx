...
- Project README: [group-project-coordinator-agent/README.md](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/README.md)
- Agent source: [src/mastra/agents/group-project-coordinator-agent.ts](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/src/mastra/agents/group-project-coordinator-agent.ts)
- Tool: [src/mastra/tools/group-project-coordinator-tool.ts](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/src/mastra/tools/group-project-coordinator-tool.ts)
- Workflow: [src/mastra/workflows/group-project-coordinator-workflow.ts](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/src/mastra/workflows/group-project-coordinator-workflow.ts)
- Entrypoint: [src/index.ts](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/src/index.ts) and [src/mastra/index.ts](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/src/mastra/index.ts)
...
- Config
  - [package.json](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/package.json)
  - [tsconfig.json](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/tsconfig.json)
  - [README.md](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/README.md)
- Agents
  - [src/mastra/agents/group-project-coordinator-agent.ts](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/src/mastra/agents/group-project-coordinator-agent.ts)
  - Specialist agents (if any future extension) in same folder
- Tools
  - [src/mastra/tools/group-project-coordinator-tool.ts](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/src/mastra/tools/group-project-coordinator-tool.ts)
- Workflows
  - [src/mastra/workflows/group-project-coordinator-workflow.ts](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/src/mastra/workflows/group-project-coordinator-workflow.ts)
- Registration
  - [src/mastra/index.ts](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/src/mastra/index.ts)
  - [src/index.ts](https://github.com/swagata-cometchat/education-AI-Agent/blob/main/group-project-coordinator-agent/src/index.ts)
- Runtime build
