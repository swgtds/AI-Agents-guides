...
- **Project README**: `study-group-chat-agent/README.md`
- **Primary Agent**: `src/mastra/index.ts` (agent registration)
- **Coordinator Logic**: `src/mastra/agents/study-buddy-coordinator-agent.ts`
- **Specialists**: `src/mastra/agents/`
  - `study-group-formation-agent.ts`
  - `homework-help-agent.ts`
  - `exam-prep-agent.ts`
  - `schedule-coordinator-agent.ts`
  - `motivation-agent.ts`
- **Tool**: `src/mastra/tools/study-buddy-coordinator-tool.ts`
- **Workflow**: `src/mastra/workflows/study-buddy-workflow.ts`
...
Key components:
- Agent container: `src/mastra/index.ts`
- Coordinator: `study-buddy-coordinator-agent.ts`
- Tool bridge: `study-buddy-coordinator-tool.ts`
- Workflow: `study-buddy-workflow.ts`
...
- Coordinator & specialists
  - `agents/study-buddy-coordinator-agent.ts`
  - `agents/study-group-formation-agent.ts`
  - `agents/homework-help-agent.ts`
  - `agents/exam-prep-agent.ts`
  - `agents/schedule-coordinator-agent.ts`
  - `agents/motivation-agent.ts`
- Tool & workflow
  - `tools/study-buddy-coordinator-tool.ts`
  - `workflows/study-buddy-workflow.ts`
