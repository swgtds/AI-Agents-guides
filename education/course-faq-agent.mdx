...
- Routes: `src/mastra/server/routes.ts`
- Server: `src/mastra/index.ts`, `src/mastra/server/util/safeErrorMessage.ts`
...
- Runtime & config
  - `course-faq-agent/package.json`
  - `course-faq-agent/tsconfig.json`
  - `course-faq-agent/README.md`
- Agent
  - `course-faq-agent/src/mastra/agents/course-faq-agent.ts`
- Tools
  - `course-faq-agent/src/mastra/tools/docs-retriever.ts`
  - `course-faq-agent/src/mastra/tools/ingest-sources.ts`
  - `course-faq-agent/src/mastra/tools/index.ts`
- Server
  - `course-faq-agent/src/mastra/index.ts`
  - `course-faq-agent/src/mastra/server/routes.ts`
  - `course-faq-agent/src/mastra/server/util/safeErrorMessage.ts`
- Knowledge
